  ...
  var T = {
    en: {
      ...
      equip: {
        ...
        app5_title:'Industrial Equipment',     app5_desc:'Deep cleaning of heavy machinery, removing oxidation and built-up residue.',
        app6_title:'Paint &amp; Coating Removal', app6_desc:'Non-abrasive stripping of paint, epoxy and protective coatings from any surface.',
    ...
    pl: {
      ...
      equip: {
        ...
        app5_title:'Sprzęt Przemysłowy', app5_desc:'Głębokie czyszczenie ciężkich maszyn, usuwanie utlenienia i nagromadzonych osadów.',
        app6_title:'Usuwanie Farb i Powłok', app6_desc:'Nieobraźliwe usuwanie farby, epoksydu i powłok ochronnych z każdej powierzchni.',
    ...
    sk: {
      ...
      home: {
        ...
        tagline_sub: 'Odstráňte hrdzu, farbu, olej, nátery a nečistoty laserom. Bez chemikálií. Bez poškodenia. Dokonalý výsledok.',
        explore_btn: 'Naše Služby →',
      ...
      wood: {
        ...
        pill1:'Drevené Okenné Rámy', pill2:'Reštaurovanie Dverí', pill3:'Čistenie Nábytku',
        ...
        eco_note:'Bezpečná, neabrazívna technológia technológia bez chemikálií, ideálna pre jemné drevené povrchy a reštaurovátorské projekty.',
        img1_title:'Okenné Rámy', img2_title:'Drevené Dvere', img3_title:'Drevený Nábytok'
      },
      metal: {
        eyebrow:'Čo Robíme', heading:'Reštaurovanie Kovov &amp;<br><span>Odhrdzavenie</span>',
        ...
        pill3:'Reštaurovanie Automobilov', pill4:'Reštaurovanie Kovových Predmetov', pill5:'Čistenie Zvarov',
        ...
        check3:'Odmastenie a odstraňovanie oleja z motorových komponentov', check4:'Odstraňovanie oxidácie zo zvarov',
        check5:'Presné čistenie zložitých kovových dielov', check6:'Neabrazívny proces, zachováva integritu kovu',
        eco_note:'Efektívna, nedeštruktívna technológia bez chemikálií. Ideálna pre rôzne kovy a renovácie vysokej hodnoty.',
      ...
      equip: {
        ...
        app1_title:'Formy a Nástroje', app1_desc:'Presné čistenie vstrekovacích foriem a nástrojov bezo zmien.',
        app2_title:'Reštaurovanie automobilov', app2_desc:'Bezpečne odstráňte hrdzu, farbu a nátery z karosérie a komponentov.',
        app3_title:'Historické Reštaurovanie', app3_desc:'Jemné čistenie historických štruktúr, kamenárstva a artefaktov.',
        app4_title:'Čistenie Zvarov', app4_desc:'Odstráňte oxidáciu a zmenu farby zo zvarov pred ošetrením alebo dokončovaním.',
        app5_title:'Priemyselné Zariadenia', app5_desc:'Hĺbkové čistenie ťažkých strojov, odstraňovanie oxidácie a nahromadených usadenín.',
        app6_title:'Odstraňovanie Farby a Náterov', app6_desc:'Neabrazívne odstraňovanie farby, epoxidu a ochranných náterov z akéhokoľvek povrchu.',
      ...
      stone: {
        ...
        detail_heading:'Obnov Kameň.<br><span style="color:var(--gold);">Odhaľ Charakter.</span>',
        ...
        eco_note:'Bezpečná, neabrazívna technológia technológia bez chemikálií, ideálna pre jemné kamenárske práce a projekty ochrany kultúrneho dedičstva.',
      ...
      antique: {
        ...
        pill4:'Mince a Medaily', pill5:'Ozdobné Predmety',
        ...
        check3:'Obnova hodín, nástrojov a kovaní',
        check4:'Čistenie mincí, medalí a drobných zberateľských predmetov',
      ...
      contact: {
        ...
        service_opt3:'Reštaurovanie automobilov',
        service_opt4:'Čistenie foriem a nástrojov',
        service_opt5:'Historické Reštaurovanie',
